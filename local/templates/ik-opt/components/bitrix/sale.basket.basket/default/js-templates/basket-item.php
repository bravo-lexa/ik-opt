...
<script id="basket-item-template" type="text/html">
		<tr class="basket-items-list-item-container{{#SHOW_RESTORE}} basket-items-list-item-container-expend{{/SHOW_RESTORE}} item"
			...
			<td class="basket-items-list-item-descriptions">
				<div class="basket-items-list-item-descriptions-inner" id="basket-item-height-aligner-{{ID}}">
					...
					<div class="basket-item-block-image<?=(!isset($mobileColumns['PREVIEW_PICTURE']) ? ' hidden-xs' : '')?>">
						{{#DETAIL_PAGE_URL}}
						<a href="{{DETAIL_PAGE_URL}}" class="basket-item-image-link item__img">
							{{/DETAIL_PAGE_URL}}
							<div class="item__img__control" style="background-image: url('{{{IMAGE_URL}}}{{^IMAGE_URL}}<?=$templateFolder?>/images/no_photo.png{{/IMAGE_URL}}')"></div>
				...
				<div class="basket-item-block-info">
                    ...
                    <div class="item__data__text">
                        <span>Наименование:
                            {{#DETAIL_PAGE_URL}}
                            <a href="{{DETAIL_PAGE_URL}}" data-entity="basket-item-name">{{NAME}}</a>
                            {{/DETAIL_PAGE_URL}}
                        </span>
                    </div>
                    <hr>
                    <? // Параметры ?>
                    <div class="item__data__text">
                        <span>Цвет линии: <b>Розовый</b></span>
                    </div>
                    <div class="item__data__text">
                        <span>Артикул: <b>KM983</b></span>
                    </div>
            ...
            if ($usePriceInAdditionalColumn)
            {
				...
				<td class="basket-items-list-item-price basket-items-list-item-price-for-one<?=(!isset($mobileColumns['PRICE']) ? ' hidden-xs' : '')?>">
                    ...
                    <div class="item__data__text">
                        <span><a href="">Цена и скидки</a></b></span>
                    </div>
                    <hr>
                    ...
                    {{#SHOW_DISCOUNT_PRICE}}
                    <div class="item__data__text">
                        <span>Старая сумма: <b>{{{FULL_PRICE_FORMATED}}}</b></span>
                    </div>
                    {{/SHOW_DISCOUNT_PRICE}}
                    <?// Обычная цена ?>
                    <div class="item__data__text" >
                        <span>Цена товара: <b id="basket-item-price-{{ID}}">{{{PRICE_FORMATED}}}</b></span>
                    </div>
                    <?// Цена за 1 шт ?>
                    <div class="item__data__text">
                        <span><?=Loc::getMessage('SBB_BASKET_ITEM_PRICE_FOR')?>: <b>  {{MEASURE_RATIO}} {{MEASURE_TEXT}}</b></span>
                    </div>
				</td>
                <?
            }
			...
			<td class="basket-items-list-item-amount">
                <?// Общяя сумма одного товара ?>
                <div class="item__data__text">
                    <span>Сумма: <b id="basket-item-sum-price-{{ID}}">{{{SUM_PRICE_FORMATED}}}</b></span>
                </div>
                ...
                <div class="item__data__delete" data-entity="basket-item-delete">
                    <svg role="img" class="icon-svg">
                        <use xlink:href="#icon-basket-delete"></use>
                    </svg>
                </div>
