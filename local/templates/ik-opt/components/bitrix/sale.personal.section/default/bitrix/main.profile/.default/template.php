...
<div class="user__login__form">
    ...
    <form method="post" name="form1" action="<?=$APPLICATION->GetCurUri()?>" enctype="multipart/form-data" role="form">
        ...
        <div class="form-group is-in-line is-in-line-3 is-offset">
            <div class="form-group-title">Контакты:</div>
            <div class="form-input">
                <input type="text" class="form-input-control" name="NAME" maxlength="50" placeholder="<?=Loc::getMessage('NAME')?>" value="<?=$arResult["arUser"]["NAME"]?>">
            </div>
            <div class="form-input">
                <input type="text" class="form-input-control" name="LAST_NAME" maxlength="50" placeholder="<?=Loc::getMessage('LAST_NAME')?>" value="<?=$arResult["arUser"]["LAST_NAME"]?>">
            </div>
            <div class="form-input">
                <input type="text" class="form-input-control" name="SECOND_NAME" maxlength="50" placeholder="<?=Loc::getMessage('SECOND_NAME')?>" value="<?=$arResult["arUser"]["SECOND_NAME"]?>">
            </div>
        </div>
        <div class="form-group is-in-line is-offset">
            <div class="form-group-title"><?=Loc::getMessage('EMAIL')?></div>
            <div class="form-input">
                <input type="text" class="form-input-control" name="EMAIL" maxlength="50" placeholder="<?=Loc::getMessage('EMAIL')?>" value="<?=$arResult["arUser"]["EMAIL"]?>">
            </div>
        </div>
        <div class="form-group is-in-line is-offset">
            <hr>
        ...
        <div class="form-group is-in-line is-offset">
            <div class="form-group-title">Смена пароля:</div>
            <div class="form-input">
                <input type="password" class="form-input-control" name="NEW_PASSWORD" maxlength="50" placeholder="Новый пароль">
            </div>
        </div>
        <div class="form-group is-in-line is-offset">
            <div class="form-group-title"></div>
            <div class="form-input">
                <input type="password" class="form-input-control" name="NEW_PASSWORD_CONFIRM" maxlength="50" placeholder="Подтверждение нового пароля">
            </div>
        </div>
        <div class="form-group is-in-line is-offset">
            <div class="form-group-title"></div>
