...
<?endif?>
    <div class="header__main__basket">
        ...
        <div class="header__main__basket__inf"><a href="<?= $arParams['PATH_TO_BASKET'] ?>"> <?echo $arResult['NUM_PRODUCTS'].' '.$arResult['PRODUCT(S)'];?></a> на <?= $arResult['TOTAL_PRICE'] ?></div>
        <div class="header__main__basket__btn"><a href="<?= $arParams['PATH_TO_BASKET'] ?>" class="btn">Оформить заказ</a></div>
        <? /*
        <div class="bx-basket-block"><?
