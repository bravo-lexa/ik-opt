...
<div class="item">
    <div class="item__wrap">
        <div class="item__img">
            <div class="item__img__control" style="background-image: url('<?=$item['PREVIEW_PICTURE']['SRC']?>')"></div>
        </div>
        <div class="item__content">
            <div class="item__content__flag">
                <div class="item__content__flag__item is-hit"><span>Хит</span></div>
                <div class="item__content__flag__item is_pasp"><span>распродажа</span></div>
            </div>
            <div class="row row-table">
                <div class="col-12">
                    <a href="<?=$item['DETAIL_PAGE_URL']?>" title="<?=$imgTitle?>" class="item__content__name"><span><?=$productTitle?></span></a>
                </div>
                <div class="col-6">
                    <div class="item__content__price"><span><?=$price['PRINT_RATIO_PRICE'];?></span></div>
                    <div class="item__content__btn-opt">
                        <a href="" title="">
                            <span>Быстрая закупка</span>
                            <svg role="img" class="icon-svg">
                                <use xlink:href="#icon-table"></use>
                            </svg>
                        </a>
                    </div>
<!--                    <div class="item__content__move"><span>Доставим 23 октября</span></div>-->
                </div>
                <div class="col-6">
                    <div class="row">
                        <div class="col-12">
            ...
            <div class="item__content__id"><span>Артикул: 2497592</span></div>
            <div class="item__content__btn-param">
                <div class="item__content__btn-param__title"><span>Рост (возраст):</span></div>
                <div class="item__content__btn-param__item"><span>992-98 см, 2-3 года</span></div>
                <div class="item__content__btn-param__item is-active"><span> 104-110 см, 4-5 лет</span></div>
                <div class="item__content__btn-param__item"><span>116-122 см, 6-7 лет</span></div>
            </div>
            <div class="item__content__data">
                <div class="item__content__data__item"><span>Россия</span></div>
                <div class="item__content__data__item"><span>Полиамид 17%,</span></div>
            </div>
        </div>
    </div>
</div>
...
<div class="item">
    <div class="item__wrap">
        <div class="item__content">
            <div class="item__content__status">
                <div class="item__content__status__skid"><span>скидка</span></div>
                <div class="item__content__status__rasp"><span>распродажа</span></div>
                <div class="item__content__status__new"><span>новое</span></div>
            </div>
            <div class="item__content__img">
                <div class="item__content__img__pic" style="background-image: url('<?=$item['PREVIEW_PICTURE']['SRC']?>')"></div>
                <div class="item__content__img__wrap">
                    <div class="item__content__img__btn">
                        <a href="javascript:" data-popup="" data-src="#catalog__item_<?=$i?>" class="btn is-mini">Быстрый просмотр</a><br>
                        <a href="" class="btn is-mini item__content__img__btn__click">Купить в 1 клик</a>
                    </div>
                </div>
            </div>
            <a href="<?=$item['DETAIL_PAGE_URL']?>" title="<?=$imgTitle?>" class="item__content__name"><span><?=$productTitle?></span></a>
            <div class="row">
                <div class="col-15 col-sm-15">
                    <div class="item__content__price">
                        <span class="item__content__price__roz"><b>256</b>руб.</span><br>
                        <span class="item__content__price__opt"><b>240</b>руб. <i>оптом</i></span>
                    </div>
                </div>
                <div class="col-9 col-sm-9">
                    <div class="item__content__size"><span>Размер:<br> 12, 14</span></div>
                </div>
            </div>
        </div>
    </div>
    <div class="item__popup popup is-big" id="catalog__item_<?=$i?>">
        <div class="popup-content">
            <?include ('templates/catalog-detail.php');?>
        </div>
    </div>
</div>
*/ ?>
