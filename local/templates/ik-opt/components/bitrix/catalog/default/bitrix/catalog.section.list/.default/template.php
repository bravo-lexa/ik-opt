    ...
    <div class="container">
        <div class="catalog__list-cat">
            <?foreach ($arResult['SECTIONS'] as &$arSection):?>
                ...
                <div class="item">
                    <div class="item__wrap" id="<?=$this->GetEditAreaId($arSection['ID'])?>">
                        <div class="item__content">
                            <a href="<?=$arSection['SECTION_PAGE_URL']?>" class="item__content__img" title="<?=$arSection['PICTURE']['TITLE']?>">
                                <div class="item__content__img__pic" style="background-image: url('<?=$arSection['PICTURE']['SRC']; ?>')"></div>
                            </a>
                            <a href="<?=$arSection['SECTION_PAGE_URL']?>" class="item__content__name"><span><?=$arSection['NAME']; ?></span></a>
                        </div>
                    </div>
                </div>
            <?endforeach;?>
